  ...
  const handleSubmit = async (e: any) => {
    ...
    if (name && phone && password) {
      setTimeout(() => {
        setSuccess(true)
        setLoading(false)
        // Store demo credentials with name
      ...
      `}</style>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
          ...
          {success ? (
            ...
            <>
              <h2 className="text-3xl font-bold text-white mb-2 text-center">FarmQuest Login</h2>
              <p className="text-center text-emerald-200 mb-8">Welcome back, farmer! Let's grow together</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-2">
                  <a className="text-sm text-emerald-300 hover:text-emerald-200 transition-colors" href="#">Forgot password?</a>
                </div>
              ...
              <div className="mt-8 text-center">
                <p className="text-emerald-200 text-sm">New to FarmQuest?</p>
                <a href="/auth/register" className="text-emerald-300 font-semibold hover:text-emerald-200 transition-colors inline-block mt-2 group">
                  Create an account
